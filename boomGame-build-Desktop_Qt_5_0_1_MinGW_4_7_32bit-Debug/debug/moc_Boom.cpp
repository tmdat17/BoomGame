...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Boom_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 34, 8)
    ...
    "Boom\0bomb_Explode\0\0collision_bomb\0"
    "drawBomb\0"
};
...
void Boom::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->bomb_Explode(); break;
        case 1: _t->collision_bomb(); break;
        case 2: _t->drawBomb(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Boom::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Boom.data,
      qt_meta_data_Boom,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Boom.stringdata))
        return static_cast<void*>(const_cast< Boom*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Boom*>(this));

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Flash_t, stringdata) + ofs \
...
const QMetaObject Flash::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Flash.data,
      qt_meta_data_Flash,  qt_static_metacall, 0, 0}
};
...
void *Flash::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Flash*>(this));
